...
const StatusDot = ({ status, priority }) => {
  ...
  return (
    <div className="relative group">
      ...
      {/* Status tooltip */}
      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
        {statusText}
...
const EyeIconOHIFButton = ({ studyInstanceUID }) => {
  ...
  return (
    <div className="relative group">
      ...
      {/* Viewer tooltip */}
      <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50">
        Open OHIF DICOM Viewer in new tab
        <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-2 border-r-2 border-t-2 border-transparent border-t-gray-800"></div>
      </div>
    </div>
  );
...
const WorklistTable = ({ 
  ...
  {[
    ...
    <div key={tab.key} className="flex-1 relative group">
      <button 
          ...
          <form onSubmit={handleSearch} className="flex w-full md:w-auto">
            <div className="relative flex-grow group">
              ...
              <input
                ...
                title="Search studies by patient name or accession number"
              />
              
              {/* Search input tooltip */}
              <div className="absolute bottom-full left-0 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-30">
                Type patient name or accession number to search
                <div className="absolute top-full left-4 w-0 h-0 border-l-2 border-r-2 border-t-2 border-transparent border-t-gray-800"></div>
              </div>
            </div>
